...
== What's in the box?
* rails_requests - Running, active and maximum number of passenger instances as well as sessions.
...
== Installation
The plugins follow the default munin installation scheme:
...
Run "/etc/munin/plugins/passenger-status autoconf" and "/etc/munin/plugins/passenger-status" to test the plugin.
...
railsdoctors.com or mail me at: bart@railsdoctors.com
